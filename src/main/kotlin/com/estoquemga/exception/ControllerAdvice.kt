...
import com.estoquemga.response.ErrorResponse
import com.estoquemga.response.FieldErrorResponse
...
class ControllerAdvice {
    ...
    private fun handleExepction(ex: NotFoundException, request: WebRequest): ResponseEntity<ErrorResponse> {
    ...
    fun handleAcceptButDenied(ex: AcceptButDenied, request: WebRequest): ResponseEntity<ErrorResponse> {
        val erro = ErrorResponse(
            HttpStatus.ACCEPTED.value(), ex.message, ex.errorCode, null
        )
